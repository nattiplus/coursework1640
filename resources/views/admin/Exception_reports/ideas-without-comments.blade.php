...
@section('AdminContent')
                <h1 class="heading">Ideas Without Comments Table</h1>
                <span class="btn btn-light">Ideas Without Comments: {{ count($ideas) }}</span>
                &emsp; 
                ...
                <div class="tabs-header">
                    <a href="{{ route('ideas.without.comments') }}" class="button-tabs-active">Ideas without a comment</a>
                    <a href="{{ route('Anonymous.ideas.and.comments') }}" class="button-tabs">Anonymous ideas and comments</a>
                </div>
                <table class="table">
                <thead>
                    <th>#</th>
                ...
                <tbody>
                    <?php
                        $paginate_ideas = App\Http\Controllers\IdeaController::paginate(collect($ideas), 10);
                    ?>
