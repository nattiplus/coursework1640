...
@section('AdminContent')
    <div class="col-md-12">
        ...
        ?>
            <form role="form" action="{{URL::to('/admin/save-department')}}" method="post">
                {{csrf_field()}}
            <div class="mb3">
                <h1 class="heading-custom">Create Department</h1>
            </div>
            ...
            <div class="wrapper">
                <div class="input-data">      
                    <input type="text" name="dept_name" id="">
                    <label for="">Department Name</label>
                </div>
                <div class="input-data">      
                    <input type="datetime-local" name="create_date" id="">
                    <label for="">Create Date</label>
                </div>
                <button type="submit" id="btn_department_create" name="add_category" class="btn btn-primary mt-3">Create</button>
            </div>
            {{-- <div class="mb-3">
            ...
            <button type="submit" name="add_department" class="btn btn-primary mt-3">Create</button> --}}
        </form>
    </div>
@endsection
...
@section('JS')
    <script type="text/javascript">
        $(document).on('click', '#btn_department_create', function(){
