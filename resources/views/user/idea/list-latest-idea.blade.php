...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="latest-ideas" role="tabpanel" aria-labelledby="latest-ideas-tab">
        Latest Idea
    </div>
</div>
@else
            ...
            ?>
                    <div class="container">
                        <ul class="nav nav-pills mt-3">
                            ...
                            <li class="nav-item">
                            <a class="nav-link active" id="btn_ideas_latest-ideas" data-url="{{ route('list.ideas.latest-ideas') }}" href="{{ route('list.ideas.latest-ideas') }}">Latest Ideas</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="latest-ideas" role="tabpanel" aria-labelledby="latest-ideas-tab">
                                <table class="table-custom">
                                    ...
                                    <tbody>
                                    <?php
                                        $ideas = App\Models\Idea::where('isApprove',true)->orderBy('create_date', 'desc')->get();
                                        $paginate_all = App\Http\Controllers\IdeaController::paginate($ideas, 5);
                                        foreach($paginate_all as $idea)
                                        { 
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td data-label="Viewer">
                                                    <p><i class="fas fa-eye " style="color: black;"></i> {{ $idea->viewers->count() }}</p>
                                                </td>
                                                <td data-label="Like">
                                                ...
                                                <td data-label="Comment">
                                                    <p><i class="fa-solid fa-comment"></i> {{ $idea->comments->count() }}</p>
                                                </td>
